...
@section("conteudo")
    ...
    <div class="col-md-6 well">
        <form class="com-md-12" action="{{ url('aluno/updatealuno') }}" method="POST">
            {{ csrf_field() }}
            <input type="hidden" name="id_aluno" value="{{ $aluno->id_aluno }}">
            <div class="form-group col-md-12 {{ $errors->has('nm_aluno') ? 'has-error' : '' }}">
                <label class="control-label">Nome:</label>
                <input type="text" name="nm_aluno" value="{{ $aluno->nm_aluno }}" class="col-md-12 form-control">
            ...
            <div class="form-group col-md-12 {{ $errors->has('ds_email') ? 'has-error' : '' }}">
                ...
                <input type="text" name="ds_email" value="{{ $aluno->ds_email }}" class="col-md-12 form-control">
            ...
            <div class="form-group col-md-12 {{ $errors->has('dt_nascimento') ? 'has-error' : '' }}">
                ...
                <input type="text" name="dt_nascimento" value="{{ $aluno->dt_nascimento }}" class="col-md-12 form-control">
